            ...
            success:function (data) {
                $.each(data,function (index,first) {
                    ...
                    $.each(first.list,function (index1,second) {
                        c += "<p style='text-align: center'><a href='#' data-options=\"iconCls:'icon-lightbulb'\" class='easyui-linkbutton' onclick=\"addTabs('" + second.iconCls + "','" + second.title + "','" + second.href + "')\">" + second.title + "</a></p>";
                    })
                    $('#aa').accordion('add', {
                        title: first.title,
                        content:c,
